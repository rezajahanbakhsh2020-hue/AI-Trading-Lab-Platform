...
/**
 * Production Gateway Port Description.
 * Represents the connected boundary port state without fabricating signal data.
 */
export const PROJECT1_GATEWAY_PORT: PortDescriptionPayload = {
